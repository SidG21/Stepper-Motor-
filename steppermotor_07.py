def forward_step_distance7(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 22  # Stepper Drive Pulses
    DIR = 24  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
...
def reverse_step_distance7(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 22  # Stepper Drive Pulses
