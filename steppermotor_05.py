def forward_step_distance5(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 35  # Stepper Drive Pulses
    DIR = 37  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
    ENA = 40  # Controller Enable Bit (High to Enable / LOW to Disable).
...
def reverse_step_distance5(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 35  # Stepper Drive Pulses
