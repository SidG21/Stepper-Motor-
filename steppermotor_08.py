def forward_step_distance8(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 8  # Stepper Drive Pulses
    DIR = 10  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
    ENA = 12  # Controller Enable Bit (High to Enable / LOW to Disable).
...
def reverse_step_distance8(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 8  # Stepper Drive Pulses
