def forward_step_distance6(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 38  # Stepper Drive Pulses
    DIR = 36  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
    ENA = 32  # Controller Enable Bit (High to Enable / LOW to Disable).
    ...
    delay = 0.00009 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.#default
    #delay = 0.0009
    #speed
...
def reverse_step_distance6(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 38  # Stepper Drive Pulses
