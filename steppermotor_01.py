def forward_step_distance1(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 3 # Stepper Drive Pulses
    DIR = 5  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
    ENA = 7  # Controller Enable Bit (High to Enable / LOW to Disable).
...
def reverse_step_distance1(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 3 # Stepper Drive Pulses
