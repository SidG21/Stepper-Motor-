def forward_step_distance3(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 19  # Stepper Drive Pulses
    ...
    delay = 0.009 # This is actualy a delay between PUL pulses - effectively sets the mtor rotation speed.#default
    #delay = 0.0009
    #speed
...
def reverse_step_distance3(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 19  # Stepper Drive Pulses
