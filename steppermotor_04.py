def forward_step_distance4(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 29  # Stepper Drive Pulses
    DIR = 31  # Controller Direction Bit (High for Controller default / LOW to Force a Direction Change).
    ENA = 33  # Controller Enable Bit (High to Enable / LOW to Disable).
...
def reverse_step_distance4(step_distance):
    from time import sleep
    import RPi.GPIO as GPIO
    #
    PUL = 29  # Stepper Drive Pulses
